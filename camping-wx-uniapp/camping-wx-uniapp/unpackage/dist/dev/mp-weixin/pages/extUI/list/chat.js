...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    g: common_vendor.f($data.listData, (item, k0, i0) => {
      return {
        a: "466da57a-10-" + i0 + "," + ("466da57a-9-" + i0),
        b: item.id,
        c: "466da57a-9-" + i0 + ",466da57a-8",
        d: common_vendor.p({
          title: item.author_name,
          avatar: item.cover,
          note: item.title,
