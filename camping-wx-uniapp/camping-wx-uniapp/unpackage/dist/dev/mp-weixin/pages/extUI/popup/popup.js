...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
    ...
    y: common_vendor.sr("popup", "3a9e57ba-6"),
    ...
    C: common_vendor.sr("message", "3a9e57ba-7"),
    D: common_vendor.p({
      type: "message"
    }),
    ...
    H: common_vendor.sr("alertDialog", "3a9e57ba-9"),
    I: common_vendor.p({
      type: "dialog"
    }),
    J: common_vendor.sr("inputClose", "3a9e57ba-12,3a9e57ba-11"),
    ...
    M: common_vendor.sr("inputDialog", "3a9e57ba-11"),
    N: common_vendor.p({
      type: "dialog"
    }),
    O: common_vendor.sr("share", "3a9e57ba-13"),
    P: common_vendor.p({
      type: "share",
      safeArea: true,
      backgroundColor: "#fff"
