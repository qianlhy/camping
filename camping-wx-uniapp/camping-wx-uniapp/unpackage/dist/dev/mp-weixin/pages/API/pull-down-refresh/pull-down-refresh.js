...
const _sfc_main = {
  ...
  onReachBottom() {
    common_vendor.index.__f__("log", "at pages/API/pull-down-refresh/pull-down-refresh.vue:32", "onReachBottom");
    if (this.max > 40) {
  ...
  onPullDownRefresh() {
    common_vendor.index.__f__("log", "at pages/API/pull-down-refresh/pull-down-refresh.vue:43", "onPullDownRefresh");
    this.initData();
  },
  methods: {
    initData() {
