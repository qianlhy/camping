...
function parseHtml(html) {
  ...
  HTMLParser(html, {
    start: function start(tag, attrs, unary) {
      ...
      if (node.name !== tag)
        common_vendor.index.__f__("error", "at common/html-parser.js:303", "invalid state: mismatch end tag");
      if (stacks.length === 0) {
...
//# sourceMappingURL=../../.sourcemap/mp-weixin/common/html-parser.js.map
